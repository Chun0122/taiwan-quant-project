...
> 版本：v1.4（2026-08-08；v1.3 為 2026-08-04、v1.2 為 2026-08-01、v1.1 為 2026-07-31、v1.0 為 2026-07-05）
> 來源：完整 repository 探索 + 深度工程審計 + CTO Roadmap 三輪分析的整併定稿；v1.1 併入 discover 選股邏輯全鏈路審計（`logs/audit_discover_20260731/REPORT.md`）；v1.3 併入跨模式 PIT 歷史重放審計（`logs/pit_crossmode_20260804/REPORT.md`）；v1.4 併入 momentum 全期 PIT 重放（`logs/pit_momentum_20260807/REPORT.md`）並**改寫 §6.5 #21 裁決**。
