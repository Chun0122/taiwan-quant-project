...
class TestComputeMetrics:
    def test_total_return(self):
        ...
        metrics = engine._compute_metrics(
            equity, trades, date(2024, 1, 1), date(2024, 12, 31)
        )
    ...
    def test_max_drawdown(self):
        ...
        metrics = engine._compute_metrics(
            equity, [], date(2024, 1, 1), date(2024, 12, 31)
        )
...
class TestComputeKellyFraction:
    ...
    def test_known_kelly_value(self):
        ...
        # kelly = 0.6 - 0.4/2 = 0.4
        trades = (
            [TradeRecord(entry_date=date(2024, 1, i+1), entry_price=100, pnl=200) for i in range(6)]
